...
y(:,1,1)=[0.6;0.8;1;0];    
    ...
    for i=4:N
        y(:,1,i+1)=y(:,1,i)+h*(55*Kepler_func(y(:,1,i))/24-59*Kepler_func(y(:,1,i))/24+37*Kepler_func(y(:,1,i))/24-9*Kepler_func(y(:,1,i-3))/24);
    end
% plot(y(1,:),y(2,:),'--k');
% hold on;
% 
...
% xlabel('x(\theta)');
% ylabel('y(\theta)');
% legend('4 step Adams-Bashforth','Actual path','Start point');
